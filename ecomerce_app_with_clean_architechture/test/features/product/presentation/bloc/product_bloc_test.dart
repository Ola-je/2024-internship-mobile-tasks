...
//   //   const tUpdateProductParam = UpdateProductParam(product: Products(id: 1, price: 1000, name: 'Product 1', description: 'Description', imagePath: 'imagePath'));

//   //   BlocT<ProductBloc, ProductState>(
//   //     'should call the InputConverter to validate and convert the string to an unsigned integer',
//   //     build: () {
//   //       when(mockInputConverter.stringToUnsignedInteger(any)).thenReturn(Right(1));
//   //       return bloc;
//   //     },
//   //     act: (bloc) => bloc.add(UpdateProductEvent(tUpdateProductParam.product)),
//   //     verify: (_) {
//   //       verify(mockInputConverter.stringToUnsignedInteger(tUpdateProductParam.product.id.toString()));
//   //     }
//   //   );
